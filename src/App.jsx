      ...
      {phase === 'invite' ? (
        <div className={`relative flex flex-col items-center justify-center min-h-screen px-4 py-12 text-center z-10 transition-all duration-1000 ${isLoaded ? 'opacity-100' : 'opacity-0 translate-y-4'}`}>
          ...
          <div className="max-w-3xl relative w-full">
            ...
            <h2 className="text-[#8b1e1e] uppercase tracking-[0.4em] md:tracking-[0.8em] text-[9px] md:text-[10px] font-bold mb-4 opacity-60 text-center font-sans">A sincere request for</h2>

            <h1 className="text-[32px] sm:text-5xl md:text-7xl font-light mb-6 md:mb-8 tracking-tight text-[#2d2424] leading-tight px-2 drop-shadow-sm">
              Alyssa <span className="italic font-normal text-[#8b1e1e] family-cursive">"Twirly Sundae"</span> Chiu
            </h1>
            ...
            <div className="text-lg md:text-2xl text-[#6e5a5a] mb-10 md:mb-12 leading-relaxed max-w-xl mx-auto italic font-light space-y-6 md:space-y-8 text-left md:text-center px-4">
              ...
              <p className="opacity-95 border-l-2 md:border-l-0 md:border-y border-[#8b1e1e]/5 py-4 px-5 md:px-6 not-italic font-serif">
              ...
              <p className="font-semibold text-[#8b1e1e] not-italic pt-4 md:pt-6 tracking-wider text-2xl md:text-4xl animate-bounce-subtle leading-snug drop-shadow-sm">
                kayaa even if it’s a little last minute — will you be my valentine??
              </p>
            </div>
            ...
            <div className="flex flex-col md:flex-row gap-4 md:gap-8 items-center justify-center relative w-full min-h-[160px] md:min-h-[140px]">
              ...
              <button
                ...
                className="w-full md:w-auto px-10 py-5 border border-[#8b1e1e]/30 text-[#8b1e1e] rounded-none hover:bg-[#8b1e1e] hover:text-white transition-all z-10 bg-white/40 backdrop-blur-md uppercase tracking-[0.2em] text-[10px] font-bold font-sans"
              >
                No
              </button>
            </div>
        ...
        <div className="max-w-3xl mx-auto px-4 md:px-6 py-12 md:py-20 animate-in fade-in slide-in-from-bottom-12 duration-1000 z-10">
          <div className="bg-white/95 backdrop-blur-sm p-8 md:p-20 shadow-[0_50px_100px_rgba(0,0,0,0.08)] relative border border-[#f0eadd]">
            ...
            <div className="mb-10 md:mb-14 text-center border-b border-[#f0e0e0] pb-10 md:pb-12 relative">
              ...
              <p className="text-[#6e5a5a] italic text-2xl md:text-3xl mb-6">"Crush mo talaga ako noh?"</p>
            ...
            <div className="space-y-8 text-lg md:text-xl leading-relaxed text-[#3d3333] font-light">
              <p className="font-semibold text-[#8b1e1e] text-2xl md:text-3xl mb-4 italic">hey crushh,</p>
              <p>
              ...
              <p className="font-semibold text-[#8b1e1e] pt-6 text-xl md:text-2xl border-t border-[#f0e0e0] mt-10">
                and if ever in the future... will you keep being my valentine, Twirly Sundae?
              </p>
            </div>

            <footer className="mt-16 md:mt-24 pt-10 md:pt-12 border-t border-[#f0e0e0] flex flex-col items-center">
              <p className="italic text-2xl md:text-3xl mb-3 opacity-70">Sincerely,</p>
              <p className="text-[#8b1e1e] font-bold tracking-[0.3em] md:tracking-[0.4em] uppercase text-xs md:text-sm border-b border-[#8b1e1e]/20 pb-2 font-sans">
          ...
          <div className="mt-12 md:mt-16 text-center text-[#8b1e1e]/20 text-[9px] md:text-[10px] tracking-[0.4em] md:tracking-[0.5em] uppercase font-bold font-sans">
            OO NA CRUSH KITA
          </div>
        </div>
      )}
